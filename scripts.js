...
//         schemeItem.textContent = scheme.name;
//         schemeItem.title = scheme.description;
...
// const educationSchemes = [
//     { name: "Scheme 1", description: "sms scheme Description of Scheme 2 " },
//     { name: "Scheme 2", description: "Description of Scheme 2" },
//     // Add more schemes
// ];
...
//         schemeNameLink.href = 'scheme-details.html'; // Link to the scheme details page
...
//             toggleDescription(description); // Toggle description visibility
//         });
...
//     // Check for keywords related to redirection
//     if (message.toLowerCase().includes('call'|| 'call support')) {
//         const botBubble = document.createElement('div');
//         botBubble.className = 'bot-bubble';
//         botBubble.textContent = "Redirecting you to a phone call...";
//         chatDisplay.appendChild(botBubble);
...
//             window.location.href = 'tel:6380666426';
//         }, 10000); // 10 seconds
//     } else if (message.toLowerCase().includes('email'|| 'Email support')) {
//         const botBubble = document.createElement('div');
//         botBubble.className = 'bot-bubble';
//         botBubble.textContent = "Redirecting you to email...";
//         chatDisplay.appendChild(botBubble);
